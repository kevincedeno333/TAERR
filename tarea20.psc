...
Funcion ejer20
    ...
    Definir alumnos_menos_40, alumnos_40_50, alumnos_50_60, alumnos_mas_60 Como Entero
    Definir peso, suma_menos_40, suma_40_50, suma_50_60, suma_mas_60 Como Real
    ...
    // Bucle de entrada de datos (hasta que se ingrese 0)
    Repetir
        ...
        Sino Si peso >= 40 Y peso < 50 Entonces
			...
			Sino Si peso >= 50 Y peso < 60 Entonces
				...
				Sino Si peso >= 60 Y peso > 0 Entonces
	...
	Hasta Que peso = 0 // El bucle se cierra al ingresar 0
